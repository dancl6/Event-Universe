...
var googApiJs = localStorage.getItem("googApi");
var googSrc = "https://maps.googleapis.com/maps/api/js?key="+ googApiJs; 
var elScript = document.getElementById("map-script1");
elScript.setAttribute("src", googSrc);
